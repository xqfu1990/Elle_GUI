...
public class GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jBPositions.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ELLE_GUI/images/button1.png"))); // NOI18N
        ...
        jBTrades.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ELLE_GUI/images/button1.png"))); // NOI18N
        ...
        jBAllocations.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ELLE_GUI/images/button3.png"))); // NOI18N
        ...
        jBSymbol.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ELLE_GUI/images/filter.png"))); // NOI18N
        jBSymbol.setText(" ");
        ...
        jBDateRange.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ELLE_GUI/images/filter.png"))); // NOI18N
        jBDateRange.setText(" ");
...
//        displaySymbol();
        ...
        createTable.setSymbolFilter(createTable.sorter, jTSymbol.getText());      // <-- set row filter here!
...
//        displayDateRange();
    ...
    private void jCDateRangeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCDateRangeActionPerformed
        if (jCDateRange.isSelected()) {
            ...
            createTable.setDateFilter(createTable.sorter, jTStartDate.getText(), jTEndDate.getText());
            createTable.table.setRowSorter(createTable.sorter);
//            int index_symbol = createTable.createTable.getColumnModel()
//                    .getColumnIndex("Symbol");
//            monitorTableChange(index_symbol + 1);
            int col = createTable.table.getColumnModel().getColumnCount();
            int i, index_date = -1; // pass -1 to monitorTableChange if date column could not be found
            for (i = 0; i < col; i++) {
                if (createTable.table.getModel().getColumnName(i).matches(".*Time.*")) {   // find date column
    ...
    private void jCSymbolActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCSymbolActionPerformed
        if (jCSymbol.isSelected()) {
            createTable.setSymbolFilter(createTable.sorter, jTSymbol.getText());
            createTable.table.setRowSorter(createTable.sorter);
            int index_symbol = createTable.table.getColumnModel()
                    .getColumnIndex("Symbol");
            monitorTableChange(index_symbol);
...
//        if (!showTable.startsWith("#") && !showTable.startsWith("*"))
